...
- [CodeRabbit review workflow](coderabbit-review-workflow.md) — trigger once per PR at open and never again; poll `issues/<N>/comments` for all three outcomes, because a clean review leaves `pulls/<N>/reviews` empty.
