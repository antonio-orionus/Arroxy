...
[**最新リリース →**](../../releases/latest) &nbsp;·&nbsp; [Windows](#download) · [macOS](#download) · [Linux](#download)
...
### <a id="win"></a>Windows：インストーラ vs ポータブル
