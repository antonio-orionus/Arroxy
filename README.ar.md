...
- تصدير **صوت فقط** إلى MP3 أو AAC أو Opus
...
نعم. اختر *صوت فقط* من قائمة الصيغ واختر MP3 أو AAC أو Opus.
...
| الميزة    | الوصف    |
| ---------------- | ---------------- |
| **تنزيل قوائم التشغيل والقنوات** | الصق رابط قائمة تشغيل أو قناة؛ ضع جميع الفيديوهات في قائمة مع فلاتر التاريخ أو العدد |
| **إدخال روابط متعددة** | الصق روابط متعددة دفعة واحدة وشغِّلها معاً |
| **تحويل الصيغ** | تحويل التنزيلات إلى MP3 أو WAV أو FLAC بدون أداة منفصلة |
