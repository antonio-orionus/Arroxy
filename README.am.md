...
**አንብብ በ:** [Afaan Oromoo](README.om.md) · [Deutsch](README.de.md) · [English](README.md) · [Español](README.es.md) · [Français](README.fr.md) · [Kiswahili](README.sw.md) · [O'zbekcha](README.uz.md) · **አማርኛ** · [العربية](README.ar.md) · [اردو](README.ur.md) · [پښتو](README.ps.md) · [বাংলা](README.bn.md) · [हिन्दी](README.hi.md) · [မြန်မာဘာသာ](README.my.md) · [Ελληνικά](README.el.md) · [Русский](README.ru.md) · [Српски](README.sr.md) · [Українська](README.uk.md) · [中文](README.zh.md) · [日本語](README.ja.md)

[![ስሪት](https://img.shields.io/github/v/release/antonio-orionus/Arroxy?label=Release&color=blueviolet)](https://github.com/antonio-orionus/Arroxy/releases/latest) [![ግንባታ](https://img.shields.io/github/actions/workflow/status/antonio-orionus/Arroxy/release.yml?label=Build)](https://github.com/antonio-orionus/Arroxy/actions/workflows/release.yml) ![ፈቃድ](https://img.shields.io/badge/license-MIT-green) ![ሥርዓቶች](https://img.shields.io/badge/platform-cross--platform-1f2937?logo=github&logoColor=white) ![ቋንቋዎች](https://img.shields.io/badge/i18n-19_languages-blue)
...
[**↓ የቅርብ ጊዜ ስሪት አውርድ**](../../releases/latest) &nbsp;·&nbsp; [Windows](#download) · [macOS](#download) · [Linux](#download)
...
- [ለምን Arroxy](#why)
- [ምንም ኩኪ፣ ምንም ግባ፣ ምንም ሒሳብ ትስስር](#no-cookies)
- [ባህሪያት](#features)
- [አውርድ](#download)
- [ግላዊነት](#privacy)
- [ተደጋጋሚ ጥያቄዎች](#faq)
...
## <a id="no-cookies"></a>ምንም ኩኪ፣ ምንም ግባ፣ ምንም ሒሳብ ትስስር
...
1. የተላኩ ክፍለ ጊዜዎች በተለምዶ በ~30 ደቂቃ ውስጥ ያበቃሉ፣ ስለዚህ ሁልጊዜ ይልካሉ።
2. yt-dlp ራሱ [ኩኪ ላይ የሚመሠረት አውቶሜሽን Google ሒሳብዎን ሊለይ ይችላል ሲል ያስጠነቅቃል](https://github.com/yt-dlp/yt-dlp/wiki/Extractors#exporting-youtube-cookies)።
...
<details>
<summary><strong>በ macOS ላይ ለመጀመሪያ ጊዜ አስጀምር</strong></summary>

Arroxy ገና ኮድ አልተፈረመበትም፣ ስለዚህ macOS Gatekeeper በመጀመሪያ አስጀማሪ ሲያስጠነቅቅዎ ይጠብቁ። ይህ ተጠበቀ ነው — የጉዳት ምልክት አይደለም።

**የሥርዓት ቅንብሮች ዘዴ (ምከረ):**

1. የ Arroxy አፕ አዶ ላይ ቀኝ ጠቅ ያድርጉ እና **Open** ይምረጡ።
2. የማስጠንቀቂያ መልዕክት ሳጥን ይታያሉ — **Cancel** ጠቅ ያድርጉ (*Move to Trash* አይጫኑ)።
3. **System Settings → Privacy & Security** ይክፈቱ።
4. ወደ **Security** ክፍል ያሸብልሉ። *"Arroxy was blocked from use because it is not from an identified developer."* ያዩሉ።
5. **Open Anyway** ጠቅ ያድርጉ እና በይለፍ ቃልዎ ወይም Touch ID ያረጋግጡ።
...
<details>
<summary><strong>በ Linux ላይ ለመጀመሪያ ጊዜ አስጀምር</strong></summary>
...
አዎ። ከቅርጸት ምናሌ *ድምፅ ብቻ* ይምረጡ እና MP3፣ AAC፣ ወይም Opus ይምረጡ።
...
| ባህሪ    | ዝርዝር    |
| ---------------- | ---------------- |
| **ፕሌይሊስት እና ቻናል ማውረዶች** | ፕሌይሊስት ወይም ቻናል URL ይለጥፉ; ሁሉም ቪዲዮዎችን በቀን ወይም ብዛት ማጣሪያ ወረፋ ያስቀምጡ |
| **ቡድን URL ግቤት** | ብዙ URLs አንድ ጊዜ ይለጥፉ እና አንድ ጊዜ ያሂዱ |
| **ቅርጸት ቀይሮ** | ማውረዶቹን ወደ MP3፣ WAV፣ FLAC ሳይለዩ ሶፍትዌር ቀይሩ |
