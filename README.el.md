...
[**↓ Λήψη Τελευταίας Έκδοσης**](../../releases/latest) &nbsp;·&nbsp; [Windows](#download) · [macOS](#download) · [Linux](#download)
...
- **Μόνο ήχος** εξαγωγή σε MP3, AAC ή Opus
...
Ναι. Επιλέξτε *μόνο ήχο* στο μενού μορφής και διαλέξτε MP3, AAC ή Opus.
