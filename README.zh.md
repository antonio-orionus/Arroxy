...
[**最新版本 →**](../../releases/latest) &nbsp;·&nbsp; [Windows](#download) · [macOS](#download) · [Linux](#download)
...
**能下播放列表吗？**
目前支持单个视频。播放列表和频道支持在路线图里 — 见 [计划中的功能](#features)。
