...
- **23 мов** — автоматично визначає локаль системи, можна перемкнути будь-коли
...
- **Завантажень одночасно та автоповтор** — обирайте, скільки завантажень із черги йде одночасно, і дозвольте тимчасовим збоям повторюватися самим зі зростаючою паузою
