...
[**Última versión →**](../../releases/latest) &nbsp;·&nbsp; [Windows](#download) · [macOS](#download) · [Linux](#download)
...
- [¿Por qué Arroxy?](#why)
- [Qué hace](#what)
- [Funciones planeadas](#features)
- [Descargar](#download)
  - [Windows: Instalador vs Portátil](#win)
  - [Primer arranque en macOS](#macos)
  - [Primer arranque en Linux](#linux)
- [Privacidad](#privacy)
- [Preguntas frecuentes](#faq)
- [Detalles técnicos](#tech)
...
## <a id="features"></a>Funciones planeadas
...
### <a id="win"></a>Windows: Instalador vs Portátil
...
### <a id="macos"></a>Primer arranque en macOS
...
### <a id="linux"></a>Primer arranque en Linux
...
**Flatpak (alternativa con sandbox)**
