...
export const ar = {
  ...
  f1_h: "حتى 4K UHD",
  f1_p: "‏2160p و1440p و1080p و720p — كل دقة يتيحها يوتيوب، إضافة إلى الصوت فقط بصيغ MP3 وAAC وOpus.",
  f2_h: "60 إطار/ث وHDR محفوظان",
  f2_p: "تصلك بثوث معدل الإطار العالي وHDR كما شفّرها يوتيوب تماماً — بلا أي فقد في الجودة.",
  f3_h: "عدة مقاطع في آنٍ واحد",
  f3_p: "أضف ما تشاء إلى قائمة الانتظار. لوحة التحميل تتابع تقدم كل مقطع بالتوازي.",
  f4_h: "تحديثات تلقائية",
  f4_p: "يحافظ Arroxy على تحديث yt-dlp وffmpeg — يعمل مع كل تغيير يُجريه يوتيوب.",
  f5_h: "9 لغات",
  f5_p: "‏English وEspañol وDeutsch وFrançais و日本語 و中文 وРусский وУкраїнська وहिन्दी — يكتشف لغتك تلقائياً.",
  f6_h: "متعدد المنصات",
  ...
  p3_h: "بلا معرّفات مستخدم",
  p3_p: "قياسات عن بُعد مجهولة الهوية ومحدودة بالجلسة عبر Aptabase — بلا معرّفات تثبيت، بلا بصمة رقمية، بلا بيانات شخصية. تحميلاتك وسجلّك وملفاتك لا تغادر جهازك أبداً.",
  ...
  faq_a1:
    "كل ما يوفره يوتيوب — 4K UHD (2160p) و1440p QHD و1080p Full HD و720p و480p و360p والصوت فقط. تُحفظ بثوث معدل الإطار العالي (60 إطار/ث، 120 إطار/ث) ومحتوى HDR كما هي. يعرض Arroxy كل صيغة متاحة ويتيح لك اختيار ما تريده بالضبط.",
  faq_q2: "هل هو مجاني فعلاً؟",
  faq_a2: "نعم. رخصة MIT. بلا خطة مميزة، بلا قيود على الميزات.",
  faq_q3: "بكم لغة يتوفر Arroxy؟",
  faq_a3:
    "تسع لغات، جاهزة للاستخدام: English وEspañol (الإسبانية) وDeutsch (الألمانية) وFrançais (الفرنسية) و日本語 (اليابانية) و中文 (الصينية) وРусский (الروسية) وУкраїнська (الأوكرانية) وहिन्दी (الهندية). يكتشف Arroxy لغة نظام تشغيلك تلقائياً عند الإطلاق الأول، ويمكنك التبديل في أي وقت من محدد اللغة في شريط الأدوات. تقع ملفات الترجمة كأوبجكتات TypeScript بسيطة في src/shared/i18n/locales/ — افتح طلب سحب على GitHub للمساهمة.",
  faq_q4: "هل أحتاج إلى تثبيت أي شيء؟",
  faq_a4:
    "لا. يُحمَّل yt-dlp وffmpeg تلقائياً عند الإطلاق الأول من إصداراتهما الرسمية على GitHub ويُخزَّنان على جهازك. بعد ذلك، لا تحتاج أي إعداد إضافي.",
  ...
  faq_a6:
    "تدعم النسخة الحالية مقاطع الفيديو المفردة. دعم قوائم التشغيل والقنوات على خارطة الطريق.",
