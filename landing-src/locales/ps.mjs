...
export const ps = {
  ...
  f1_h: "تر 4K UHD پورې",
  f1_p: "2160p، 1440p، 1080p، 720p — د یوتیوب هر ریزولیوشن، سربیره پر یوازې غږ MP3، AAC، او Opus.",
  ...
  f3_h: "یو وخت کې ډیرو",
  f3_p: "هومره ویډیوګانې چې غواړئ قطار کې اضافه کړئ. د ډاونلوډ پینل د هر یو پرمختګ موازي توګه تعقیبوي.",
  f4_h: "اوتومات تازه کول",
  f4_p: "Arroxy د پس پرده yt-dlp او ffmpeg تازه ساتي — د یوتیوب هر بدلون سره کار کوي.",
  f5_h: "۹ ژبې",
  f5_p: "English، Español، Deutsch، Français، 日本語، 中文، Русский، Українська، हिन्दी — ستاسو ژبه اوتومات کشف کوي.",
  f6_h: "چند پلیټفارمه",
  ...
  p3_p: "د Aptabase له لارې نه-پیژندل شوي، یوازې د سیشن ټیلیمیټري — د نصب IDs نشته، fingerprinting نشته، شخصي معلومات نشته. ستاسو ډاونلوډونه، تاریخچه، او فایلونه هیڅکله ستاسو ماشین نه وځي.",
  ...
  faq_a1:
    "هر هغه شی چې یوتیوب وړاندې کوي — 4K UHD (2160p)، 1440p QHD، 1080p Full HD، 720p، 480p، 360p، او یوازې غږ. د لوړ فریم ریټ سټریمونه (60 fps، 120 fps) او HDR منځپانګه لکه چې ده ساتل کیږي. Arroxy تاسو ته هر موجود بڼه ښیي او تاسو ته اجازه درکوي چې دقیقاً هغه غوره کړئ چې غواړئ.",
  ...
  faq_a3:
    "نهه، له صندوقه: English، Español (سپانوي)، Deutsch (جرماني)، Français (فرانسوي)، 日本語 (جاپاني)، 中文 (چیني)، Русский (روسي)، Українська (اوکراني)، او हिन्दी (هندي). Arroxy ستاسو د عملیاتي سیسټم ژبه د لومړي پیلولو پر مهال اوتومات کشفوي او تاسو کولی شئ هر وخت د ټول بار کې د ژبې پیک نه بدل کړئ. ژباړې د ساده TypeScript اعتراضونو په توګه src/shared/i18n/locales/ کې اوسیږي — د مرستې لپاره GitHub کې PR پرانیزئ.",
  ...
  faq_a6:
    "نن ورځ یوازې یوازینۍ ویډیوګانې ملاتړ کیږي. د پلې لیست او چینل ملاتړ روډمیپ کې دی.",
