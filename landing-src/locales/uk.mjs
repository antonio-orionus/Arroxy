...
export const uk = {
  title: "Arroxy — Безкоштовний завантажувач YouTube 4K, без входу",
  description:
    "Безкоштовний настільний завантажувач YouTube з ліцензією MIT для Windows, macOS і Linux. Завантажуйте відео до 4K HDR при 60 fps без облікового запису Google, браузерних cookies і будь-якого входу.",
  og_title: "Arroxy — Безкоштовний завантажувач YouTube 4K, без входу",
  og_description:
    "Безкоштовний завантажувач YouTube 4K. Без cookies, без входу, без зламаних сесій. Ліцензія MIT. Windows · macOS · Linux.",
  ...
  hero_h1_a: "Безкоштовний завантажувач YouTube 4K.",
  hero_h1_b: "Без cookies. Без входу. Без зламаних сесій.",
  hero_tagline:
    "Arroxy — безкоштовний настільний завантажувач YouTube з ліцензією MIT для Windows, macOS і Linux. Завантажує відео до 4K HDR при 60 fps — не запитуючи облікового запису Google, браузерних cookies чи будь-якого входу.",
  pill_no_tracking: "Без стеження",
  pill_no_account: "Без облікового запису Google",
  ...
  p3_h: "Без ідентифікаторів користувача",
  p3_p: "Анонімна, лише сесійна телеметрія через Aptabase — без install ID, без знімання відбитків, без особистих даних. Ваші завантаження, історія та файли ніколи не залишають вашу машину.",
