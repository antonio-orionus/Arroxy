...
export const hi = {
  ...
  p3_h: "कोई यूज़र ID नहीं",
  p3_p: "Aptabase के ज़रिए गुमनाम, केवल-सेशन टेलीमेट्री — कोई इंस्टॉल ID नहीं, कोई फ़िंगरप्रिंटिंग नहीं, कोई व्यक्तिगत डेटा नहीं। आपके डाउनलोड, इतिहास और फ़ाइलें कभी आपकी मशीन नहीं छोड़तीं।",
