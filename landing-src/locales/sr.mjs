...
export const sr = {
  ...
  f5_h: "9 језика",
  f5_p: "English, Español, Deutsch, Français, 日本語, 中文, Русский, Українська, हिन्दी — аутоматски препознаје ваш.",
  ...
  faq_a3:
    "На деветом, одмах из кутије: English, Español (шпански), Deutsch (немачки), Français (француски), 日本語 (јапански), 中文 (кинески), Русский (руски), Українська (украјински) и हिन्दी (хинди). Arroxy аутоматски препознаје језик вашег оперативног система при prvom покретању и можете да пређете на други у сваком тренутку преко бирача језика у траци са алаткама. Преводи су обични TypeScript објекти у src/shared/i18n/locales/ — отворите PR на GitHub-у да допринесете.",
