...
export const ru = {
  ...
  p3_h: "Без идентификаторов пользователя",
  p3_p: "Анонимная телеметрия только для сессии через Aptabase — никаких ID установки, никакого фингерпринтинга, никаких личных данных. Ваши загрузки, история и файлы никогда не покидают ваше устройство.",
