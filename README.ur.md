...
[**↓ تازہ ترین ریلیز ڈاؤن لوڈ کریں**](../../releases/latest) &nbsp;·&nbsp; [Windows](#download) · [macOS](#download) · [Linux](#download)
...
- **صرف آڈیو** کو MP3، AAC یا Opus میں ایکسپورٹ
...
ہاں۔ فارمیٹ مینو میں *audio-only* منتخب کریں اور MP3، AAC یا Opus چنیں۔
...
| خصوصیت    | تفصیل    |
| ---------------- | ---------------- |
| **پلے لسٹ اور چینل ڈاؤن لوڈز** | ایک پلے لسٹ یا چینل URL پیسٹ کریں؛ تاریخ یا تعداد کے فلٹرز کے ساتھ تمام ویڈیوز کو قطار میں لگائیں |
| **بیچ URL ان پٹ** | ایک ساتھ کئی URLs پیسٹ کریں اور انہیں ایک ساتھ چلائیں |
| **فارمیٹ کنورژن** | کسی الگ ٹول کے بغیر ڈاؤن لوڈز کو MP3، WAV، FLAC میں تبدیل کریں |
