  ...
  async getFormats(url: string): Promise<Result<GetFormatsOutput>> {
    try {
      if (this.mockMode) {
        return ok({
          formats: [
            { formatId: '137', label: '1080p | mp4 | 30fps', ext: 'mp4', resolution: '1080p', fps: 30, isVideoOnly: true },
            { formatId: '22', label: '720p | mp4 | 30fps', ext: 'mp4', resolution: '720p', fps: 30, isVideoOnly: false },
            { formatId: '18', label: '360p | mp4 | 30fps', ext: 'mp4', resolution: '360p', fps: 30, isVideoOnly: false }
          ],
