...
const ALLOWED: Record<string, readonly string[]> = {
	...
	binary_setup_failed: ['binary', 'phase', 'code', 'error_code', 'status_code', 'operation', 'setup_step', 'source_kind', 'source_channel', 'source_provider', 'elapsed_ms'],
	binary_probe_anomaly: ['binary', 'outcome', 'failure_kind', 'code', 'source_kind', 'source_channel', 'source_provider', 'elapsed_ms', 'timeout_ms', 'attempt_index'],
