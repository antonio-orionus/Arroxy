const el = {
  ...
  wizard: {
    ...
    url: {
      ...
      networkPacing: {
        heading: 'Ήπιες λήψεις',
        description: 'Προσθέτει μικρές παύσεις κατά τη διάρκεια κάθε λήψης ώστε το Arroxy να μην πιέζει υπερβολικά τον ιστότοπο. Οι τιμές είναι σε δευτερόλεπτα εκτός αν αναφέρεται διαφορετικά.',
        presetLabel: 'Πόσο προσεκτικό πρέπει να είναι το Arroxy;',
        tooltip: 'Αυτές οι παύσεις γίνονται μέσα σε κάθε λήψη. Το Arroxy εξακολουθεί να κρατά τις κανονικές λήψεις σε ουρά μία τη φορά.',
        summary: 'Παύσεις: {{requests}} μεταξύ ελέγχων, {{downloads}} πριν ξεκινήσει το μέσο, {{subtitles}} πριν τα αρχεία υποτίτλων. Συνδέσεις: {{fragments}}.',
        presets: {
        ...
        tooltips: {
          off: 'Χρησιμοποιεί μόνο τις μικρές βασικές παύσεις που κρατά το Arroxy για μέσα και υποτίτλους.',
          balanced: 'Προεπιλογή. Προσθέτει σύντομες παύσεις και χρησιμοποιεί μία σύνδεση λήψης.',
          careful: 'Προσθέτει μεγαλύτερες παύσεις για μεγάλες playlist ή δίκτυα που συχνά φτάνουν στα όρια.',
          custom: 'Ρύθμισε μόνος σου τους σύνθετους ελέγχους ανά λήψη.'
        },
        fields: {
          sleepRequests: 'Αναμονή μεταξύ ελέγχων μεταδεδομένων',
          sleepInterval: 'Παύση πριν ξεκινήσει το μέσο: ελάχιστο',
          maxSleepInterval: 'Παύση πριν ξεκινήσει το μέσο: μέγιστο',
          sleepSubtitles: 'Αναμονή πριν τα αρχεία υποτίτλων',
          concurrentFragments: 'Συνδέσεις λήψης'
        },
        units: {
          seconds: 'δευτ.',
          threads: 'νήματα'
