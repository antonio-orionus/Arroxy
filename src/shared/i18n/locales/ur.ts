const ur = {
  ...
  wizard: {
    ...
    url: {
      ...
      playlistProbeLimit: {
        label: 'اسکین کرنے کے لیے Playlist آئٹمز',
        description: 'Arroxy کی زیادہ سے زیادہ اندراجات جو playlist، چینل، یا تلاش کا نتیجہ کھولنے پر لوڈ کرتا ہے۔',
        option: '{{count}} آئٹمز',
        current: 'موجودہ لمٹ: {{count}} آئٹمز',
        customValue: 'حسب ضرورت: {{count}} آئٹمز',
        custom: 'حسب ضرورت…',
        customDialogTitle: 'حسب ضرورت Playlist اسکین لمٹ',
        customDialogDescription: '{{min}} سے {{max}} تک پورا عدد استعمال کریں۔',
        customDialogCancel: 'منسوخ کریں',
        customDialogSave: 'لمٹ محفوظ کریں',
        invalid: '1 سے 5000 تک پورا عدد استعمال کریں',
        tooltip: 'yt-dlp --playlist-end سے میپ ہوتا ہے: Arroxy پِکر بناتے وقت صرف اتنے playlist، چینل، یا تلاش کے اندراجات مانگتا ہے۔'
      },
      singleFilenameId: {
      ...
      networkPacing: {
        ...
        tooltips: {
          off: 'صرف وہ چھوٹے بنیادی وقفے استعمال کرتا ہے جو Arroxy میڈیا اور سب ٹائٹلز کے لیے رکھتا ہے۔',
          balanced: 'پہلے سے طے شدہ۔ مختصر وقفے شامل کرتا ہے اور ایک ڈاؤن لوڈ کنکشن استعمال کرتا ہے۔',
          careful: 'بڑی پلے لسٹس یا ان نیٹ ورکس کے لیے زیادہ وقفے شامل کرتا ہے جو اکثر حدود تک پہنچتے ہیں۔',
          custom: 'فی ڈاؤن لوڈ ایڈوانسڈ کنٹرولز خود ترتیب دیں۔'
        },
        fields: {
  ...
  errors: {
    ytdlp: {
      botBlock:
        'بوٹ پروٹیکشن فعال ہو گئی۔ آپ کا IP ممکنہ طور پر فلیگ کیا گیا ہے (ڈیٹا سینٹر رینج یا مصروف VPN ایگزٹ)۔ اپنا IP تبدیل کریں یا کوئی مختلف VPN اینڈ پوائنٹ منتخب کریں اور دوبارہ کوشش کریں۔ اگر مسئلہ برقرار رہے تو یہ YouTube کی طرف سے ایک عارضی تبدیلی ہو سکتی ہے — Arroxy لانچ پر yt-dlp کو خودکار طور پر اپ ڈیٹ کرتا ہے، اس لیے جیسے ہی اپ اسٹریم حل شائع کرے، یہ خود بخود لاگو ہو جائے گا۔',
