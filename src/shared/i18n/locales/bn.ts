const bn = {
  ...
  wizard: {
    ...
    url: {
      ...
      networkPacing: {
        heading: 'মৃদু ডাউনলোড',
        description: 'প্রতিটি ডাউনলোডের সময় ছোট বিরতি যোগ করুন যাতে Arroxy সাইটে অতিরিক্ত চাপ না দেয়। মান সেকেন্ডে, অন্যথায় উল্লেখ না থাকলে।',
        presetLabel: 'Arroxy কতটা সতর্ক হবে?',
        tooltip: 'এই বিরতিগুলো প্রতিটি ডাউনলোডের ভেতরে হয়। Arroxy তবুও সাধারণ কিউ করা ডাউনলোড একটি একটি করে রাখে।',
        summary: 'বিরতি: {{requests}} চেকের মাঝে, {{downloads}} মিডিয়া শুরুর আগে, {{subtitles}} সাবটাইটেল ফাইলের আগে। সংযোগ: {{fragments}}।',
        presets: {
          off: 'বন্ধ',
          balanced: 'সুষম',
          careful: 'সতর্ক',
        ...
        tooltips: {
          off: 'শুধুমাত্র Arroxy যে ছোট বেসলাইন বিরতি মিডিয়া ও সাবটাইটেলের জন্য রাখে তা ব্যবহার করে।',
          balanced: 'ডিফল্ট। ছোট বিরতি যোগ করে এবং একটি ডাউনলোড সংযোগ ব্যবহার করে।',
          careful: 'বড় প্লেলিস্ট বা যে নেটওয়ার্কে প্রায়ই সীমা লাগে তার জন্য দীর্ঘ বিরতি যোগ করে।',
          custom: 'ডাউনলোডের উন্নত নিয়ন্ত্রণগুলো নিজে সেট করুন।'
        },
        fields: {
          sleepRequests: 'মেটাডেটা চেকের মাঝে বিরতি',
          sleepInterval: 'মিডিয়া শুরুর আগে বিরতি: সর্বনিম্ন',
          maxSleepInterval: 'মিডিয়া শুরুর আগে বিরতি: সর্বোচ্চ',
          sleepSubtitles: 'সাবটাইটেল ফাইলের আগে বিরতি',
          concurrentFragments: 'ডাউনলোড সংযোগ'
        },
        units: {
          seconds: 'সে',
          threads: 'থ্রেড'
