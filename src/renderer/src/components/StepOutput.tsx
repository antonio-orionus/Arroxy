    ...
    <div className="wizard-step flex flex-col gap-1.5" data-testid="step-output">
      <div className="flex flex-col gap-3 py-1">
        <div className="flex items-center justify-between gap-3">
          <div className="flex flex-col gap-0.5">
            <span className="text-[13px] font-medium text-foreground">
              {t('wizard.output.embedChapters.label')}
            </span>
            <span className="text-[11px] text-[var(--text-subtle)]">
              {t('wizard.output.embedChapters.description')}
            </span>
          </div>
          <Switch
            checked={wizardEmbedChapters}
            onCheckedChange={setEmbedChapters}
            aria-label={t('wizard.output.embedChapters.label')}
            data-testid="embed-chapters-toggle"
          />
        </div>
        ...
        <div className="flex items-center justify-between gap-3">
          <div className="flex flex-col gap-0.5">
            <span className="text-[13px] font-medium text-foreground">
              {t('wizard.output.embedMetadata.label')}
            </span>
            <span className="text-[11px] text-[var(--text-subtle)]">
              {t('wizard.output.embedMetadata.description')}
            </span>
          </div>
          <Switch
            checked={wizardEmbedMetadata}
            onCheckedChange={setEmbedMetadata}
            aria-label={t('wizard.output.embedMetadata.label')}
            data-testid="embed-metadata-toggle"
          />
        </div>
        ...
        <div className="flex items-center justify-between gap-3">
          <div className="flex flex-col gap-0.5">
            <span className="text-[13px] font-medium text-foreground">
              {t('wizard.output.embedThumbnail.label')}
            </span>
            <span className="text-[11px] text-[var(--text-subtle)]">
              {t('wizard.output.embedThumbnail.description')}
            </span>
          </div>
          <Switch
            checked={wizardEmbedThumbnail}
