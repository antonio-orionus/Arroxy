...
export function WizardPanel(): JSX.Element {
  ...
  return (
    <section className="px-6 py-5 border-b border-zinc-800" data-testid="wizard-panel">
      {wizardStep !== 'error' && (
        <div className="flex items-center gap-0 mb-6" aria-hidden data-testid="step-indicator">
          {STEPS.map((step, i) => {
