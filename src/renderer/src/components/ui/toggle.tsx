...
const toggleVariants = cva("group/toggle inline-flex items-center justify-center gap-1 rounded-lg text-sm font-medium whitespace-nowrap transition-all outline-none hover:bg-muted hover:text-foreground focus-visible:border-ring focus-visible:ring-[3px] focus-visible:ring-ring/50 disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-destructive/20 aria-pressed:bg-card aria-pressed:shadow-sm aria-pressed:text-foreground data-[state=on]:bg-card data-[state=on]:shadow-sm data-[state=on]:text-foreground dark:aria-pressed:bg-accent dark:aria-pressed:shadow-none dark:data-[state=on]:bg-accent dark:data-[state=on]:shadow-none dark:aria-invalid:ring-destructive/40 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4", {
  variants: {
    variant: {
