...
// steps' Delete/Backspace removal) so a shortcut key doesn't fire while the
// user is typing into a text field — the items step's range From/To inputs,
// or a profile name/path field inside the profile editor dialog the profiles
// step can open on top of itself.
//
