...
- **শুধু অডিও** MP3, AAC বা Opus-এ এক্সপোর্ট
...
- **যেকোনো YouTube URL পেস্ট করুন** — ভিডিও ও Shorts উভয়ই সমর্থিত
...
- **৯টি ভাষা** — সিস্টেম লোকেল স্বয়ংক্রিয়ভাবে শনাক্ত করে, যেকোনো সময় পরিবর্তনযোগ্য
...
Arroxy [Aptabase](https://aptabase.com)-এর মাধ্যমে বেনামী, সমষ্টিগত টেলিমেট্রি পাঠায় — শুধু একটি ইন্ডি প্রজেক্টের জন্য যথেষ্ট যাতে দেখা যায় কেউ আদৌ ব্যবহার করছে কিনা (চালু, OS, অ্যাপ ভার্সন, ক্র্যাশ)। কোনো URL নেই, কোনো ভিডিওর শিরোনাম নেই, কোনো ফাইল পাথ নেই, কোনো IP নেই, কোনো অ্যাকাউন্টের তথ্য নেই — Aptabase ওপেন-সোর্স এবং ডিজাইন অনুযায়ী GDPR-বান্ধব। সেটিংসে অপ্ট-আউট করতে পারবেন।
...
হ্যাঁ। ফরম্যাট মেনুতে *audio-only* বেছে নিন এবং MP3, AAC বা Opus বেছে নিন।
...
নয়টি: English, Español, Deutsch, Français, 日本語, 中文, Русский, Українська, हिन्दी। সিস্টেম ভাষা স্বয়ংক্রিয়ভাবে শনাক্ত করে; টুলবার থেকে যেকোনো সময় পরিবর্তন করুন। লোকেল ফাইলগুলো `src/shared/i18n/locales/`-এ সাদামাটা TypeScript অবজেক্ট — [PR স্বাগত](../../pulls)।

**আমাকে কি আর কিছু ইনস্টল করতে হবে?**
না। yt-dlp ও ffmpeg প্রথম চালুতে তাদের অফিসিয়াল GitHub রিলিজ থেকে স্বয়ংক্রিয়ভাবে ডাউনলোড হয়ে লোকালে ক্যাশ হয়।

**আমি কি প্লেলিস্ট বা পুরো চ্যানেল ডাউনলোড করতে পারব?**
এখন শুধু একক ভিডিও ও Shorts। প্লেলিস্ট ও চ্যানেল সমর্থন [রোডম্যাপে](#roadmap) আছে।
...
| বৈশিষ্ট্য    | বিবরণ    |
| ---------------- | ---------------- |
| **প্লেলিস্ট ও চ্যানেল ডাউনলোড** | একটি প্লেলিস্ট বা চ্যানেল URL পেস্ট করুন; তারিখ বা সংখ্যার ফিল্টার দিয়ে সব ভিডিও কিউ করুন |
| **ব্যাচ URL ইনপুট** | একসাথে একাধিক URL পেস্ট করুন এবং একবারেই চালান |
| **ফরম্যাট রূপান্তর** | আলাদা টুল ছাড়াই ডাউনলোড MP3, WAV, FLAC-এ রূপান্তর করুন |
...
- **yt-dlp** + **ffmpeg** — ডাউনলোড ও মাক্স ইঞ্জিন (প্রথম চালুতে GitHub থেকে আনা হয়, সবসময় আপ-টু-ডেট)
...
> yt-dlp ও ffmpeg বান্ডেল করা নেই — প্রথম চালুতে এগুলো GitHub থেকে আনা হয় এবং আপনার অ্যাপ ডেটা ফোল্ডারে ক্যাশ করা হয়।
