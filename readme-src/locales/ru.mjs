...
export const ru = {
  ...
  feat_workflow_6:
    "**{{LANG_COUNT}} языков** — автоматически определяет язык системы, можно переключить в любой момент",
  feat_workflow_7:
