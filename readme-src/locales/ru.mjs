...
export const ru = {
  ...
  dl_linux_fuse_text: "Если запуск всё равно не удаётся — запустите без монтирования, дополнительных системных пакетов не нужно:",
  dl_linux_targz_h4: "Обычный архив (без FUSE, без установки):",
  dl_linux_targz_text: "Сборка `.tar.gz` — то же приложение без обёртки AppImage: распакуйте куда угодно и запустите. Ничего устанавливать не нужно, системные пакеты не требуются.",
