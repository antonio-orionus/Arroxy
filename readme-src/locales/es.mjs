...
export const es = {
  ...
  dl_linux_fuse_text: "Si el arranque sigue fallando, ejecútalo sin montar — no hace falta ningún paquete adicional del sistema:",
  dl_linux_targz_h4: "Tarball simple (sin FUSE, sin instalación):",
  dl_linux_targz_text: "La versión `.tar.gz` es la misma app sin el envoltorio AppImage: descomprímela donde quieras y ejecútala. Nada que instalar, ningún paquete del sistema.",
