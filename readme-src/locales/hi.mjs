...
export const hi = {
  ...
  feat_workflow_12: "**ग्लोबल डाउनलोड हॉटकी** — किसी भी ऐप में लिंक कॉपी करें और `Ctrl+Shift+D` (macOS पर `Cmd+Shift+D`) दबाएँ; Arroxy विंडो खोले बिना आपकी सक्रिय प्रोफ़ाइल के साथ उसे कतार में डाल देता है, और एक सूचना इसकी पुष्टि करती है। डिफ़ॉल्ट रूप से चालू, फिर से सेट किया जा सकता है",
  feat_workflow_1:
  ...
  feat_workflow_6:
    "**{{LANG_COUNT}} भाषाएँ** - सिस्टम लोकेल का स्वतः पता लगाता है, किसी भी समय बदला जा सकता है",
  feat_workflow_7:
  ...
  hotkey_fig_alt: "Arroxy की ग्लोबल डाउनलोड हॉटकी — Windows और Linux पर Ctrl+Shift+D, macOS पर Cmd+Shift+D, कॉपी किया गया लिंक सीधे डाउनलोड कतार में भेजती है",
  hotkey_fig_cap: "<b>ग्लोबल डाउनलोड हॉटकी</b><br/>कहीं भी लिंक कॉपी करें, एक बार दबाएँ — वह कतार में आकर डाउनलोड होने लगता है",
  ...
  dl_macos_warning:
    "Arroxy अभी कोड-साइन्ड नहीं है, इसलिए macOS Gatekeeper पहले लॉन्च पर damaged app चेतावनी दिखा सकता है। यह अपेक्षित है — इसका मतलब यह नहीं कि फाइलें सच में खराब हैं।",
  dl_macos_m1_h4: "Terminal तरीका:",
  dl_macos_step1: "माउंट किए गए DMG से `Arroxy.app` को `/Applications` में खींचें।",
  dl_macos_step2:
    "Terminal खोलें और `sudo xattr -dr com.apple.quarantine /Applications/Arroxy.app` चलाएँ।",
  dl_macos_step3: "`open /Applications/Arroxy.app` चलाएँ।",
  dl_macos_step4:
    "अगर app path अलग है, तो `/Applications/Arroxy.app` को अपने install path से बदलें।",
  dl_macos_step5:
    "अगर `sudo` पूछे तो अपने Mac का password डालें।",
  dl_macos_after:
    "quarantine हटने के बाद Arroxy सामान्य रूप से खुलेगा।",
  dl_macos_m2_h4: "Terminal तरीका:",
  dl_macos_note:
  ...
  dl_linux_fuse_text: "अगर फिर भी नहीं चलता, तो इसे माउंट किए बिना चलाएँ — FUSE पैकेज की ज़रूरत नहीं:",
  dl_linux_targz_h4: "सादा टारबॉल (FUSE नहीं, इंस्टॉल नहीं):",
  dl_linux_targz_text: "`.tar.gz` बिल्ड वही ऐप है, बस AppImage रैपर के बिना — कहीं भी एक्सट्रैक्ट करें और चलाएँ। न इंस्टॉलर चाहिए, न FUSE पैकेज।",
  dl_linux_flatpak_prereq: "Ubuntu में Flatpak की जगह Snap आता है, इसलिए पहले Flatpak इंस्टॉल करें और Flathub जोड़ें — बंडल अपना रनटाइम वहीं से लेता है:",
  dl_linux_arch_note: "**रिलीज़ पेज पर Linux डाउनलोड सिर्फ़ x86_64 के लिए हैं।** ARM64 मशीनों (Raspberry Pi, Asahi Linux) पर Flatpak इंस्टॉल तो हो जाता है, पर लॉन्च पर `bwrap: execvp ldconfig: Exec format error` के साथ विफल होता है।",
  ...
  dl_macos_sequoia_h4: "मौजूदा macOS के लिए Terminal fix",
  dl_macos_sequoia_intro:
    "Arroxy को Applications में कॉपी करने के बाद Terminal इस्तेमाल करें:",
  dl_macos_sequoia_step1:
    "माउंट किए DMG से `Arroxy.app` को `/Applications` में खींचें।",
  dl_macos_sequoia_step2:
    "Terminal खोलें और ये दो commands चलाएँ:",
  dl_macos_sequoia_step3:
    "Arroxy लॉन्च करने के लिए `open /Applications/Arroxy.app` चलाएँ।",
  dl_macos_sequoia_step4:
    "अगर app path अलग है, तो `/Applications/Arroxy.app` को अपने install path से बदलें।",
  dl_macos_sonoma_h4: "पुराने macOS के लिए Terminal fix",
  dl_macos_sonoma_step1:
    "माउंट किए DMG से `Arroxy.app` को `/Applications` में खींचें।",
  dl_macos_sonoma_step2:
    "Terminal खोलें और `/Applications/Arroxy.app` से quarantine हटाएँ।",
  dl_macos_sonoma_step3:
    "quarantine हटने के बाद Arroxy को Terminal या Finder से लॉन्च करें।",
  dl_macos_damaged_h4:
  ...
  support_h2: "Arroxy का समर्थन करें",
