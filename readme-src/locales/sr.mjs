...
export const sr = {
  ...
  dl_linux_fuse_text: "Ако покретање и даље не успе, покрените без монтирања — додатни системски пакети нису потребни:",
  dl_linux_targz_h4: "Обична архива (без FUSE, без инсталације):",
  dl_linux_targz_text: "`.tar.gz` издање је иста апликација без AppImage омотача — распакујте било где и покрените. Нема шта да се инсталира, системски пакети нису потребни.",
