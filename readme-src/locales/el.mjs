...
export const el = {
  ...
  feat_workflow_6:
    "**22 γλώσσες** — ανιχνεύει αυτόματα τις τοπικές ρυθμίσεις του συστήματος, με δυνατότητα εναλλαγής ανά πάσα στιγμή",
  feat_workflow_7:
