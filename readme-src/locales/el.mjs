...
export const el = {
  ...
  dl_h2: "Εγκατάσταση και πρώτη εκκίνηση",
  privacy_h2: "Απόρρητο",
  ...
  feat_workflow_6:
    "**23 γλώσσες** — ανιχνεύει αυτόματα τις τοπικές ρυθμίσεις του συστήματος, με δυνατότητα εναλλαγής ανά πάσα στιγμή",
  feat_workflow_7:
  ...
  dl_macos_warning:
    "Το Arroxy δεν έχει ακόμα υπογραφεί ψηφιακά, οπότε το macOS Gatekeeper μπορεί να εμφανίσει προειδοποίηση κατεστραμμένης εφαρμογής στην πρώτη εκκίνηση. Αυτό είναι αναμενόμενο — δεν σημαίνει ότι τα αρχεία είναι πραγματικά κατεστραμμένα.",
  dl_macos_m1_h4: "Μέθοδος Terminal:",
  dl_macos_step1:
    "Σύρετε το `Arroxy.app` από το προσαρτημένο DMG στο `/Applications`.",
  dl_macos_step2:
    "Ανοίξτε το Terminal και εκτελέστε `sudo xattr -dr com.apple.quarantine /Applications/Arroxy.app`.",
  dl_macos_step3: "Εκτελέστε `open /Applications/Arroxy.app`.",
  dl_macos_step4:
    "Αν η διαδρομή της εφαρμογής είναι διαφορετική, αντικαταστήστε το `/Applications/Arroxy.app` με τη διαδρομή εγκατάστασης.",
  dl_macos_step5:
    "Πληκτρολογήστε τον κωδικό του Mac σας αν το ζητήσει το `sudo`.",
  dl_macos_after:
    "Αφού αφαιρεθεί η καραντίνα, το Arroxy ανοίγει κανονικά.",
  dl_macos_m2_h4: "Μέθοδος Terminal:",
  dl_macos_note:
  ...
  dl_macos_sequoia_h4: "Διόρθωση Terminal για το τρέχον macOS",
  dl_macos_sequoia_intro:
    "Χρησιμοποιήστε το Terminal αφού αντιγράψετε το Arroxy στα Applications:",
  dl_macos_sequoia_step1:
    "Σύρετε το `Arroxy.app` από το τοποθετημένο DMG στον φάκελο `/Applications`.",
  dl_macos_sequoia_step2:
    "Ανοίξτε το Terminal και εκτελέστε αυτές τις δύο εντολές:",
  dl_macos_sequoia_step3:
    "Εκτελέστε `open /Applications/Arroxy.app` για να ξεκινήσει το Arroxy.",
  dl_macos_sequoia_step4:
    "Αν η διαδρομή της εφαρμογής είναι διαφορετική, αντικαταστήστε το `/Applications/Arroxy.app` με τη διαδρομή εγκατάστασης.",
  dl_macos_sonoma_h4: "Διόρθωση Terminal για παλαιότερα macOS",
  dl_macos_sonoma_step1:
    "Σύρετε το `Arroxy.app` από το τοποθετημένο DMG στον φάκελο `/Applications`.",
  dl_macos_sonoma_step2:
    "Ανοίξτε το Terminal και αφαιρέστε το quarantine από το `/Applications/Arroxy.app`.",
  dl_macos_sonoma_step3:
    "Ξεκινήστε το Arroxy από Terminal ή Finder αφού αφαιρεθεί το quarantine.",
  dl_macos_damaged_h4:
    "Διόρθωση quarantine Gatekeeper",
  dl_macos_damaged_p:
  ...
  faq_a6:
    "Είκοσι τρεις, εκτός συσκευασίας: English, Bahasa Indonesia (Ινδονησιακά), Español (Ισπανικά), Deutsch (Γερμανικά), Français (Γαλλικά), 日本語 (Ιαπωνικά), 中文 (Κινέζικα), Ρωσικά (Κινέζικα), Ρωσικά (Κινέζικα), (Ουκρανικά), हिन्दी (Χίντι), Afaan Oromoo, Kiswahili, O'zbekcha (Ουζμπεκικό), Tiếng Việt (Βιετναμέζικα), Türkçe, አማርኛ (Αμχαρικά), العربية (Παρουμπική), اردوښ (Παρουβική), اردوσ বাংলা (Βεγγαλικά), မြန်မာဘာသာ (Βιρμανικά), Ελληνικά (Ελληνικά) και Српски (Σερβικά). Το Arroxy εντοπίζει αυτόματα τη γλώσσα του λειτουργικού σας συστήματος κατά την πρώτη εκκίνηση και μπορείτε να κάνετε εναλλαγή ανά πάσα στιγμή από τον επιλογέα γλώσσας στη γραμμή εργαλείων. Τοπικές ρυθμίσεις Runtime Το JSON ζει στο src/shared/i18n/locales/ και οι κατάλογοι PO που απευθύνονται σε μεταφραστή ζουν στο i18n/locales/ — ανοίξτε ένα PR στο GitHub για να συνεισφέρετε.",
