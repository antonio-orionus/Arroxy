...
export const el = {
  ...
  feat_workflow_10:
    "**Παράλληλες λήψεις και αυτόματη επανάληψη** — κατέβασε πολλά στοιχεία της ουράς ταυτόχρονα και επανάλαβε αυτόματα τις προσωρινές αποτυχίες με αυξανόμενη αναμονή",
