...
export const el = {
  ...
  feat_workflow_6:
    "**{{LANG_COUNT}} γλώσσες** — εντοπίζει αυτόματα τη γλώσσα συστήματος, με αλλαγή οποιαδήποτε στιγμή",
  feat_workflow_7:
  ...
  feat_workflow_10:
    "**Ταυτόχρονες λήψεις και αυτόματη επανάληψη** — διάλεξε πόσες λήψεις της ουράς τρέχουν ταυτόχρονα και άσε τις προσωρινές αποτυχίες να επαναλαμβάνονται μόνες τους με αυξανόμενη αναμονή",
