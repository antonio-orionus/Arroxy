...
export const el = {
  ...
  dl_linux_fuse_text: "Αν η εκκίνηση εξακολουθεί να αποτυγχάνει, τρέξτε το χωρίς προσάρτηση — δεν χρειάζονται επιπλέον πακέτα συστήματος:",
  dl_linux_targz_h4: "Απλό αρχείο tar (χωρίς FUSE, χωρίς εγκατάσταση):",
  dl_linux_targz_text: "Η έκδοση `.tar.gz` είναι η ίδια εφαρμογή χωρίς το περίβλημα AppImage — αποσυμπιέστε την οπουδήποτε και τρέξτε την. Τίποτα προς εγκατάσταση, κανένα πακέτο συστήματος.",
