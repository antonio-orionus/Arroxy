...
export const tr = {
  ...
  dl_linux_fuse_text: "Açılış hâlâ başarısızsa bağlamadan çalıştırın — ek sistem paketi gerekmez:",
  dl_linux_targz_h4: "Düz arşiv (FUSE yok, kurulum yok):",
  dl_linux_targz_text: "`.tar.gz` sürümü, AppImage sarmalayıcısı olmayan aynı uygulamadır — istediğiniz yere çıkarın ve çalıştırın. Kurulacak bir şey yok, sistem paketi gerekmez.",
