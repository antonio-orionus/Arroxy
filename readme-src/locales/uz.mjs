...
export const uz = {
  ...
  dl_linux_fuse_text: "Agar ishga tushirish hali ham muvaffaqiyatsiz bo'lsa, uni mount qilmasdan ishga tushiring — qo'shimcha tizim paketlari kerak emas:",
  dl_linux_targz_h4: "Oddiy tarball (FUSE ham, o'rnatish ham kerak emas):",
  dl_linux_targz_text: "`.tar.gz` to'plami — AppImage qobig'isiz o'sha ilovaning o'zi: istalgan joyga chiqaring va ishga tushiring. Hech narsa o'rnatish shart emas, tizim paketlari ham talab qilinmaydi.",
