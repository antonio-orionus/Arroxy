...
export const ur = {
  ...
  feat_workflow_6:
    "**23 زبانیں** — سسٹم لوکیل کا خود بخود پتہ لگاتا ہے، کسی بھی وقت تبدیل کیا جا سکتا ہے۔",
  feat_workflow_7:
  ...
  faq_a6:
    "تئیس، باکس سے باہر: English، Bahasa Indonesia (انڈونیشیائی)، Español (ہسپانوی)، Deutsch (جرمن)، Français (فرانسیسی)، 日本語 (جاپانی)، 中文 (چینی)، روسی (روسی)، روسی (یوکرینی)، ہندی (ہندی)، Afaan Oromoo، Kiswahili، O'zbekcha (ازبک)، Tiếng Việt (ویت نامی)، Türkçe، አማርኛ (امہاری)، العربية (عربی)، اردو (اردو)، انگریزی (پشتو)، (بنگالی)، မြန်မာဘာသာ (برمی)، Ελληνικά (یونانی)، اور Српски (سربیائی)۔ Arroxy پہلی لانچ پر آپ کے آپریٹنگ سسٹم کی زبان کا خود بخود پتہ لگاتا ہے اور آپ ٹول بار میں لینگویج چننے والے سے کسی بھی وقت سوئچ کر سکتے ہیں۔ Runtime لوکل JSON src/shared/i18n/locales/ میں رہتا ہے، اور مترجم کا سامنا کرنے والے PO کیٹلاگ i18n/locales/ میں رہتے ہیں — تعاون کرنے کے لیے GitHub پر PR کھولیں۔",
