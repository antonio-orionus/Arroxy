...
export const ur = {
  ...
  feat_workflow_10:
    "**ایک وقت میں ڈاؤن لوڈز اور خودکار دوبارہ کوشش** — منتخب کریں کہ قطار کے کتنے ڈاؤن لوڈز ایک ساتھ چلیں، اور عارضی ناکامیاں بڑھتے انتظار کے ساتھ خود دوبارہ کوشش کریں",
