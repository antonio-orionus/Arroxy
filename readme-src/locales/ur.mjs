...
export const ur = {
  ...
  feat_workflow_6:
    "**22 زبانیں** — سسٹم لوکیل کا خود بخود پتہ لگاتا ہے، کسی بھی وقت تبدیل کیا جا سکتا ہے۔",
  feat_workflow_7:
