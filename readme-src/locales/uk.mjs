...
export const uk = {
  ...
  feat_workflow_6:
    "**22 мови** — автоматично визначає локаль системи, яку можна будь-коли перемикати",
  feat_workflow_7:
