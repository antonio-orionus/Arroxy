...
export const uk = {
  ...
  feat_workflow_6:
    "**{{LANG_COUNT}} мов** — автоматично визначає локаль системи, можна перемкнути будь-коли",
  feat_workflow_7:
  ...
  faq_a6:
    "{{LANG_COUNT}} мов доступні одразу: {{LANG_NAME_LIST}}. Arroxy автоматично визначає мову операційної системи під час першого запуску, а перемкнути її можна будь-коли через вибір мови на панелі інструментів. Runtime locale JSON зберігається в src/shared/i18n/locales/, а PO-каталоги для перекладачів — в i18n/locales/ — відкрийте PR на GitHub, щоб долучитися.",
