...
export const uk = {
  ...
  dl_linux_fuse_text: "Якщо запуск все одно не вдається — запустіть без монтування, додаткові системні пакунки не потрібні:",
  dl_linux_targz_h4: "Звичайний архів (без FUSE, без встановлення):",
  dl_linux_targz_text: "Збірка `.tar.gz` — той самий застосунок без оболонки AppImage: розпакуйте будь-куди й запустіть. Нічого встановлювати не треба, системні пакунки не потрібні.",
