...
[**Dernière version →**](../../releases/latest) &nbsp;·&nbsp; [Windows](#download) · [macOS](#download) · [Linux](#download)
...
- [Pourquoi Arroxy ?](#why)
- [Ce qu'il fait](#what)
- [Fonctions prévues](#features)
- [Téléchargement](#download)
  - [Windows : Installeur vs Portable](#win)
  - [Premier lancement sur macOS](#macos)
  - [Premier lancement sur Linux](#linux)
- [Confidentialité](#privacy)
- [Questions fréquentes](#faq)
- [Détails techniques](#tech)
...
## <a id="features"></a>Fonctions prévues
...
### <a id="win"></a>Windows : Installeur vs Portable
...
### <a id="macos"></a>Premier lancement sur macOS
...
### <a id="linux"></a>Premier lancement sur Linux
...
**Flatpak (alternative en sandbox)**
...
## <a id="tech"></a>Détails techniques
