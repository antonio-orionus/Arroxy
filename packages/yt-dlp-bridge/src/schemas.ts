...
export const YtDlpOutputEventKindSchema = z.enum(['destination', 'merge', 'already-downloaded', 'move', 'artifact', 'sleep', 'sponsorblock-fetch', 'sponsorblock-retry', 'transfer-retry', 'postprocess', 'progress'])
