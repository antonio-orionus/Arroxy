...
**ဘာသာဖြင့် ဖတ်ရှုရန်:** [Afaan Oromoo](README.om.md) · [Bahasa Indonesia](README.id.md) · [Deutsch](README.de.md) · [English](README.md) · [Español](README.es.md) · [Français](README.fr.md) · [Kiswahili](README.sw.md) · [O'zbekcha](README.uz.md) · [Tiếng Việt](README.vi.md) · [አማርኛ](README.am.md) · [العربية](README.ar.md) · [اردو](README.ur.md) · [پښتو](README.ps.md) · [বাংলা](README.bn.md) · [हिन्दी](README.hi.md) · **မြန်မာဘာသာ** · [Ελληνικά](README.el.md) · [Русский](README.ru.md) · [Српски](README.sr.md) · [Українська](README.uk.md) · [中文](README.zh.md) · [日本語](README.ja.md)
...
- **22 ဘာသာစကား** — စနစ်ဒေသကို အလိုအလျောက်သိရှိနိုင်ပြီး အချိန်မရွေးပြောင်းနိုင်သည်။
...
နှစ်ဆယ့်နှစ်၊ ကွက်လပ်- English၊ Bahasa Indonesia (အင်ဒိုနီးရှား)၊ Español (စပိန်)၊ Deutsch (ဂျာမန်)၊ Français (French)၊ 日本語 (ဂျပန်)၊ 中文 (уRсe)၊ Українська (ယူကရိန်း)၊ हिन्दी (ဟိန်ဒီ)၊ Afaan Oromoo၊ Kiswahili၊ O'zbekcha (ဥဇဘက်)၊ Tiếng Việt (ဗီယက်နမ်)၊ አማርኛ (Amharic) ၊ الوربي پښتو (Pashto)၊ বাংলা (ဘင်္ဂါလီ)၊ မြန်မာဘာသာ (ဗမာ)၊ Ελληνικά (ဂရိ) နှင့် Српски (ဆားဘီးယား)။ Arroxy သည် ပထမဆုံးစတင်သည့်အချိန်တွင် သင့်လည်ပတ်မှုစနစ်၏ဘာသာစကားကို အလိုအလျောက်သိရှိနိုင်ပြီး ကိရိယာဘားရှိ ဘာသာစကားရွေးချယ်သည့်စနစ်မှ အချိန်မရွေးပြောင်းနိုင်သည်။ Runtime ဒေသဆိုင်ရာ JSON သည် src/shared/i18n/locales/ တွင်နေထိုင်ပြီး ဘာသာပြန်သူ-မျက်နှာစာ PO ကတ်တလောက်များသည် i18n/locales/ တွင်နေထိုင်သည် — ပါဝင်ကူညီရန်အတွက် PR ကို GitHub တွင်ဖွင့်ပါ။
