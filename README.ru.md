...
**Язык:** [Afaan Oromoo](README.om.md) · [Bahasa Indonesia](README.id.md) · [Deutsch](README.de.md) · [English](README.md) · [Español](README.es.md) · [Français](README.fr.md) · [Kiswahili](README.sw.md) · [O'zbekcha](README.uz.md) · [Tiếng Việt](README.vi.md) · [Türkçe](README.tr.md) · [አማርኛ](README.am.md) · [العربية](README.ar.md) · [اردو](README.ur.md) · [پښتو](README.ps.md) · [বাংলা](README.bn.md) · [हिन्दी](README.hi.md) · [မြန်မာဘာသာ](README.my.md) · [Ελληνικά](README.el.md) · **Русский** · [Српски](README.sr.md) · [Українська](README.uk.md) · [中文](README.zh.md) · [日本語](README.ja.md)
...
- **23 языка** — языковой стандарт системы определяется автоматически, переключается в любой момент.
...
Двадцать три, из коробки: English, Bahasa Indonesia (индонезийский), Español (испанский), Deutsch (немецкий), Français (французский), 日本語 (японский), 中文 (китайский), Русский (русский), Українська (украинский), हिन्दी (хинди), Afaan Oromoo, Kiswahili, O'zbekcha (узбекский), Tiếng Việt (вьетнамский), Türkçe, አማርኛ (амхарский), العربية (арабский), اردو (урду), پښتو (пушту), বাংলা (бенгальский), မြန်မာဘာသာ (бирманский), Ελληνικά (греческий) и Српски (сербский). Arroxy автоматически определяет язык вашей операционной системы при первом запуске, и вы можете переключиться в любой момент с помощью средства выбора языка на панели инструментов. Локаль Runtime JSON находится в src/shared/i18n/locales/, а каталоги PO с поддержкой переводчика находятся в i18n/locales/ — откройте PR на GitHub, чтобы внести свой вклад.
