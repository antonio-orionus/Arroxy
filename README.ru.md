...
[**↓ Скачать последний релиз**](../../releases/latest) &nbsp;·&nbsp; [Windows](#download) · [macOS](#download) · [Linux](#download)
...
- **Только аудио** — экспорт в MP3, AAC или Opus
...
- **Вставьте любую YouTube-ссылку** — поддерживаются видео и Shorts
...
Arroxy отправляет анонимную агрегированную телеметрию через [Aptabase](https://aptabase.com) — ровно столько, чтобы небольшой инди-проект мог видеть, что им пользуются (запуски, ОС, версия приложения, сбои). Никаких URL, названий видео, путей к файлам, IP-адресов, информации об аккаунте — Aptabase изначально является open-source и GDPR-совместимым. Можно отключить в настройках.
...
Да. Выберите *только аудио* в меню форматов и укажите MP3, AAC или Opus.
...
Пока поддерживаются только отдельные видео и Shorts. Поддержка плейлистов и каналов есть в [дорожной карте](#roadmap).
