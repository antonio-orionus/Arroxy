...
[**Последний релиз →**](../../releases/latest) &nbsp;·&nbsp; [Windows](#скачать) · [macOS](#скачать) · [Linux](#скачать)
...
| **Загрузка субтитров**             | Получайте автоматические или ручные субтитры вместе с видео, на любом доступном языке                   |
...
### Windows: Установщик vs Портативная версия
...
Сейчас поддерживаются только отдельные видео. Поддержка плейлистов и каналов — в дорожной карте, см. [Запланированные функции](#запланированные-функции).
...
Это macOS Gatekeeper блокирует неподписанное приложение — реального повреждения нет. Пошаговая инструкция в разделе [Первый запуск на macOS](#первый-запуск-на-macos).
...
Технические детали, инструкции по сборке из исходников, требования по платформам и инструкции для контрибьюторов — см. в [README на английском](README.md#tech-details).
