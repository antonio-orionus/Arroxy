...
- **Языки: 23** — автоматически определяет язык системы, можно переключить в любой момент
...
- **Загрузок одновременно и автоповтор** — выбирайте, сколько загрузок из очереди идёт одновременно, и позвольте временным сбоям повторяться сами с растущей паузой
