...
[**नवीनतम रिलीज़ →**](../../releases/latest) &nbsp;·&nbsp; [Windows](#डाउनलोड) · [macOS](#डाउनलोड) · [Linux](#डाउनलोड)
...
### Windows: इंस्टॉलर बनाम पोर्टेबल
...
अभी सिंगल वीडियो सपोर्टेड हैं। प्लेलिस्ट और चैनल सपोर्ट रोडमैप पर है — देखें [आने वाले फ़ीचर](#आने-वाले-फ़ीचर)।
...
यह macOS Gatekeeper बिना साइन की हुई ऐप को ब्लॉक कर रहा है — असली नुक़सान नहीं है। क़दम-दर-क़दम के लिए देखें [macOS पर पहली बार लॉन्च](#macos-पर-पहली-बार-लॉन्च)।
...
तकनीकी विवरण, सोर्स से बिल्ड करने के निर्देश, प्लेटफ़ॉर्म-वार ज़रूरतें और योगदान कैसे करें, इसके लिए [अंग्रेज़ी README](README.md#tech-details) देखें।
